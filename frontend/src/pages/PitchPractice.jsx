        ...
        <main className="flex-1 overflow-y-auto custom-scrollbar p-6 lg:p-10">
          <div className="max-w-6xl mx-auto">
            <header className="mb-10">
              <h1 className="text-4xl font-black text-white mb-2">Pitch Practice</h1>
              <p className="text-emerald-500/60 font-medium">Refine your elevator pitch with AI-powered feedback.</p>
            </header>
