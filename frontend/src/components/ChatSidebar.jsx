...
export default function ChatSidebar() {
    ...
    return (
        <aside className="w-96 border-l border-slate-200 dark:border-slate-700 bg-white dark:bg-background-dark flex flex-col hidden lg:flex h-full">
            ...
            <div className="p-4 bg-white dark:bg-background-dark border-t border-slate-200 dark:border-slate-800 shrink-0">
