    ...
    return (
        <aside className="w-16 md:w-64 border-r border-slate-300 dark:border-white/10 flex flex-col items-center md:items-stretch py-6 gap-8 bg-white dark:bg-slate-900/80 backdrop-blur-2xl sticky top-0 h-screen">
                ...
                {children || (
                    <>
                        <div className="p-2 text-primary bg-primary/10 rounded-xl cursor-pointer flex items-center gap-3">
                            ...
                            <span className="hidden md:block text-sm font-black text-primary">Dashboard</span>
                        </div>
                        <div className="p-2 text-black dark:text-slate-300 hover:text-primary dark:hover:text-primary cursor-pointer transition-colors flex items-center gap-3">
                        ...
                        <div className="p-2 text-black dark:text-slate-300 hover:text-primary dark:hover:text-primary cursor-pointer transition-colors relative flex items-center gap-3">
            ...
            <div className="mt-auto px-4 flex flex-col gap-2">
                {footer || (
                    <div className="p-2 text-black dark:text-slate-400 hover:text-primary cursor-pointer transition-colors flex items-center gap-3">
                        <span className="material-symbols-outlined text-[24px]">help</span>
                        <span className="hidden md:block text-sm font-black">Help Center</span>
                    </div>
                )}
            </div>
        </aside>
